public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Testes para HashTable de endereçamento aberto: ");
        ...
        System.out.println("Inserir valor (0,0): " + teste1.insert(0, "0"));

        System.out.println("Inserir valor (0,1): " + teste1.insert(0, "1"));
